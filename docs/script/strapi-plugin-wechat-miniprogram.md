...
`POST`
- 路径：
`STRAPI_URL/api/strapi-plugin-wechat-miniprogram/getPhoneNumber`
- body 参数：
...
`POST`
- 路径：
`STRAPI_URL/api/strapi-plugin-wechat-miniprogram/auth/openid`
- body 参数：
...
`POST`
- 路径： 
`STRAPI_URL/api/strapi-plugin-wechat-miniprogram/auth/update`
- 请求头：
